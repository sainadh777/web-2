...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/jadrn052/css/product.css" />
    <link type="text/css" rel="stylesheet" href="/jquery/jquery-ui-1.11.2/jquery-ui.css" />
    <script type="text/javascript" src="/jquery/jquery.js"></script>
    <script type="text/javascript" src="/jquery/jQueryUI.js"></script>
    <script type="text/javascript" src="/jadrn052/js/product.js"></script>
    <script type="text/javascript" src="/jadrn052/js/shopping_cart.js"></script>
...
<body>
    ...
    <div id="header">
        ...
        <h1><a href="http://jadran.sdsu.edu/jadrn052/proj2.html"><img id="logo" src="/jadrn052/proj2/logo.png" /></a></h1>
         ...
         <div id="cart">
            <a href="#"><img id="carticon" src="/jadrn052/proj2/carticon.jpg" />View Cart</a>
        ...
        <div id="checkoutdialog" title="Checkout">
            <form id="checkoutform" method="post" action="/jadrn052/servlets/OrderSummary">
    ...
    <%  List<String> list=(ArrayList<String>)request.getAttribute("product");  %>
        ...
        <div id="product">        
         ...
         <img src="http://jadran.sdsu.edu/~jadrn052/public_html/proj1/images/<%= list.get(0).toLowerCase()%>" />
        </div>

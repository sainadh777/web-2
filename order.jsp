...
<head>
    ...
    <link rel="stylesheet"type="text/css" href="/jadrn052/proj2/order.css" />
    <script type="text/javascript" src="/jadrn052/proj2/order.js"> </script>
...
<tr> 
    ...
    <td>Price</td>
     ...
     <%   List<String> items=(ArrayList<String>)request.getAttribute("summary");
    	  for(String item : items){
				out.print("<tr>");
				out.print("<td> <img src='http://jadran.sdsu.edu/~jadrn052/proj1/images/"+item.split(",")[0].toLowerCase()+"'/>"+ item.split(",")[1].split(";")[0]+" </td>");
    ...
    <form method="post" action="/jadrn052/servlets/SubmitOrder">

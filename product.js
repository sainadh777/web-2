...
$(document).ready(function () {
    ...
    $.get('http://jadran.sdsu.edu/jadrn052/servlets/GetProducts', mapskuToProduct);
    cart = new shopping_cart("jadrn052");
...
function updateDisplay() {
    ...
    if (cartArray.length > 0) {
        ...
        for (i = 0; i < cartArray.length; i++) {
            ...
            name.innerHTML ="<img src='http://jadran.sdsu.edu/~jadrn052/proj1/images/"+cartArray[i][0].toLowerCase()+"' />" + product.vendor +" " + product.id;
